...
url_three = ShortenedUrl.create_for_user_and_long_url!(u_two, "stackoverflow.com")
...
Tagging.create(topic_id: tag_one.id, url_id: url_three.id)

Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_two.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_three.id)
Visit.create(user_id: u_one.id, shortened_url_id: url_three.id)
