...
ActiveRecord::Schema.define(version: 20161205225808) do
  ...
  add_index "contact_shares", ["contact_id", "share_with_id"], name: "index_contact_shares_on_contact_id_and_share_with_id", unique: true, using: :btree
  add_index "contact_shares", ["contact_id"], name: "index_contact_shares_on_contact_id", using: :btree
  add_index "contact_shares", ["share_with_id"], name: "index_contact_shares_on_share_with_id", using: :btree
